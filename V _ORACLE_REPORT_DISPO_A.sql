...
WHERE MAT.CRITICALITY in ('A') -- bean.id
  ...
  AND MR.CREATIONDATE < CONCAT('31/12/',TO_CHAR(SYSDATE,'YYYY'))
  AND WO.WOEND > CONCAT('01/01/',TO_CHAR(SYSDATE,'YYYY'))
...
AND StartDate BETWEEN CONCAT('01/01/',TO_CHAR(SYSDATE,'YYYY')) AND CONCAT('31/12/',TO_CHAR(SYSDATE,'YYYY'))
AND EndDate BETWEEN CONCAT('01/01/',TO_CHAR(SYSDATE,'YYYY')) AND CONCAT('31/12/',TO_CHAR(SYSDATE,'YYYY'))
 GROUP BY NOM )
,
...
(SELECT SUM( (TO_CHAR(EndDate, 'DDD') - 2 ) * 14.4 *5/7
   ...
   - TO_CHAR(StartDate,'HH')
     ...
     FROM MYTABLE2 -- 2!
WHERE StartDate < CONCAT('01/01/',TO_CHAR(SYSDATE,'YYYY')) 
  AND EndDate > CONCAT('01/01/',TO_CHAR(SYSDATE,'YYYY')) 
 GROUP BY NOM )
,
...
(SELECT SUM( (365 - TO_CHAR(StartDate, 'DDD') - 2) * 14.4 * 5/7
   ...
   - TO_CHAR(StartDate,'HH')
     ...
     FROM MYTABLE2 -- 2!
WHERE  StartDate < CONCAT('31/12/',TO_CHAR(SYSDATE,'YYYY'))
  AND EndDate > CONCAT('31/12/',TO_CHAR(SYSDATE,'YYYY'))
 GROUP BY NOM )
